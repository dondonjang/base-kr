...
if ( ! function_exists( 'base_jetpack_setup' ) ) :
function base_jetpack_setup() {
     ...
     */
    add_image_size( 'base-logo', 9999, 9999 );

    add_theme_support( 'site-logo', array( 'size' => 'base-logo' ) );
}
endif;
 ...
 */
function base_retina_jetpack_site_logo( $html, $logo, $size ) {
...
add_filter( 'jetpack_the_site_logo', 'base_retina_jetpack_site_logo', 10, 3 );