...
function bean_sidebar_loader() {
	...
	$bean_sidebar_location = get_post_meta ($post->ID, '_radium_page_layout', true);
	$bean_sidebar_class = "";
	$bean_content_class = "";
	
	if ( $bean_sidebar_location === 'right' ) {
	
		$bean_sidebar_class = "five columns sidebar-right";
		$bean_content_class = "seven columns";  
	
	} elseif ( $bean_sidebar_location === 'left' ) {
	 
		$bean_sidebar_class = "sidebar-left five columns pull-seven"; 
		$bean_content_class = "seven columns push-five "; 
