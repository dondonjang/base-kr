...
function widget( $args, $instance ) {
	...
	<?php if ( $title ) echo $before_title . $title . $after_title; ?>
		...
		<form action="<?php echo $subscribecode; ?>" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
			...
			<input type="submit" value="<?php _e('Subscribe','bean'); ?>" class="base-button <?php if($animate != '') : ?>animated BeanButtonShake <?php endif; ?>">
...
function form( $instance ) {
	...
	$defaults = array(
		...
		'subscribecode' => '',
		'desc' => 'Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Etiam porta sem malesuada magna.',
		'animate' => true
		);
