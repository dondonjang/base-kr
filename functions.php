...
function bean_load_framework() {
	...
	if( bean_theme_supports( 'primary', 'widgets' ) ){
		...
		include( BEAN_WIDGETS_DIR . '/widget-categories.php' );
		include( BEAN_WIDGETS_DIR . '/widget-dribbble.php' );
		include( BEAN_WIDGETS_DIR . '/widget-feature-area.php' );
		include( BEAN_WIDGETS_DIR . '/widget-flickr.php' );
		include( BEAN_WIDGETS_DIR . '/widget-newsletter.php' );
		include( BEAN_WIDGETS_DIR . '/widget-announcement.php' );
		include( BEAN_WIDGETS_DIR . '/widget-social.php' );
		include( BEAN_WIDGETS_DIR . '/widget-sticky.php' );
	...
	if( is_admin() ) { 
		...
		include( BEAN_FUNCTIONS_DIR . '/mobile-nav.php' ); 
